...
import com.gabriel.cursospringionic.domain.PagamentoComBoleto;
import com.gabriel.cursospringionic.domain.PagamentoComCartao;
import com.gabriel.cursospringionic.domain.Pedido;
import com.gabriel.cursospringionic.domain.Produto;
import com.gabriel.cursospringionic.domain.enums.EstadoPagamento;
import com.gabriel.cursospringionic.domain.enums.Perfil;
...
import com.gabriel.cursospringionic.repositories.ItemPedidoRepository;
import com.gabriel.cursospringionic.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "gabrieldasilvasousa1406@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "gabrieldasilvasousa@gmail.com", "62788045069", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("9388321", "34252625"));
